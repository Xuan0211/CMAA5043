    ...
    const projectData = [
        {
            ...
            description: "以古建筑为主题的立体书交互解谜游戏。古建筑结构的相关知识（如斗拱、藻井等） 立体书解谜技巧（如Z形折、拉杆结构等）。让书外的玩家体验建筑背后的故事——建筑可读。立体的中国古建筑史，纸上之筑的\"奇观\"。玩家可以对纸进行拖拽、翻折、切换、推动的基础操作，通过这些机制的相互作用与配合，改变关卡的场景地形和建筑结构，为角色创造可行的道路。"
        },
        {
            id: 2,
            title: "步轻云",
